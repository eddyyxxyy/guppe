...
"""
vp = float(
    input('Informe o valor do prêmio: \033[37mR$\033[m')
    .strip()
    .replace(',', '.')
)
j1 = float(
    input('Informe quanto o jogador 1 investiu na aposta: \033[37mR$\033[m')
    .strip()
    .replace(',', '.')
)
j2 = float(
    input('Informe quanto o jogador 2 investiu na aposta: \033[37mR$\033[m')
    .strip()
    .replace(',', '.')
)
j3 = float(
    input('Informe quanto o jogador 3 investiu na aposta: \033[37mR$\033[m')
    .strip()
    .replace(',', '.')
)
total = j1 + j2 + j3
