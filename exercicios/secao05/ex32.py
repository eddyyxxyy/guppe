...
print(
    'CARDÁPIO'.center(36, '-') + '\n' +
    '| ' + 'Cachorro Quente '.center(18) + '| 100 ' + '| R$1.20 |\n' +
    '| ' + 'Bauru Simples '.center(18) + '| 101 ' + '| R$1.30 |\n' +
    '| ' + 'Bauru com ovo '.center(18) + '| 102 ' + '| R$1.50 |\n' +
    '| ' + 'Hamburguer '.center(18) + '| 103 ' + '| R$1.20 |\n' +
    '| ' + 'Cheeseburguer '.center(18) + '| 104 ' + '| R$1.70 |\n' +
    '| ' + 'Suco '.center(18) + '| 105 ' + '| R$2.20 |\n' +
    '| ' + 'Refrigerante '.center(18) + '| 106 ' + '| R$1.00 |\n' +
    '-' * 36
)
while True:
    try:
